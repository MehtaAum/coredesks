    ...
    <div>
      <div className="navbar w-full h-[60px] fixed bg-[#171717] flex justify-between items-center px-[3%] z-50">
        ...
        <div className="flex h-full  items-center gap-5  lg:gap-0">
                ...
                <div className="ham-logo border lg:hidden" onClick={handleHam}>
                ...
                <div className="logo-div w-[22vw] md:w-[14vw] h-[100%] flex justify-start items-center ">
                  <img src="/src/assets/logo.png" alt=""  className="md:w-[100px] lg:w-[6.5vw]"/>
                </div>
        ...
        <div className="flex gap-3 ">
              ...
              <div className="cursor-pointer hover:scale-[0.9] duration-[0.2s] will-change-transform border-0 text-white w-[15px] h-[15px] md:w-[24px] md:h-[24px]">
              ...
              <div className="cursor-pointer hover:scale-[0.9] duration-[0.2s] will-change-transform text-white w-[15px] h-[15px] md:w-[24px] md:h-[24px]">
